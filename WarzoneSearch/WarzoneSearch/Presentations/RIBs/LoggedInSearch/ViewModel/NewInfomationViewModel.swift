...
class NewInfomationViewModel: NewInfomationViewable {
    
    
    private var infomation: NewInfomationData?
    
    init(infomation: NewInfomationData?) {
    ...
    var avatarUrl: String {
        return infomation?.platformInfo?.avatarUrl ?? ""
    }
